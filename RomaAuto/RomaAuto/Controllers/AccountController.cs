...
namespace RomaAuto.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                var user = _db.Operators.FirstOrDefault(item => item.Name == model.Name && item.Password == model.Password);
                if (user != null)
                {
                    LoginHelper.CreateUser(new MainUser()
                    {
                        Id = user.OperatorID,
                        Name = user.Name,
